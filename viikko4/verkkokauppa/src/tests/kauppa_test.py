...
class TestKauppa(unittest.TestCase):
    ...
    def test_kahden_ostoksen_paaytyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_arvoilla(self):
        ...
        # varmistetaan, että metodia tilisiirto on kutsuttu oikeilla argumenteilla
        pankki_mock.tilisiirto.assert_called_with("pekka",ANY,"12345",ANY,11)
    ...
    def test_yhden_loppuuneen_ostoksen_paaytyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_arvoilla(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
